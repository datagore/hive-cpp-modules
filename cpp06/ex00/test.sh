...
test "999999999999999999999999999" "huge integer"
...
test ".42" "double with no integer part"
test "nan" "double NaN"

section "FLOAT TESTS"
test ".42f" "float with no integer part"
test "nanf" "float NaN"
...
test "'ab'" "char with multiple characters"
test "''" "empty single quotes"
test "'a" "missing single quote"
test "a'" "trailing single quote"
